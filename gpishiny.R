...
ui<-fluidPage(navbarPage(theme = shinytheme("readable"),  "GLOBAL PEACE INDEX VISUALIZER",
                         ...
                         tabPanel("Welcome", icon = icon("hand-spock"),
                                  ...
                                  h4("Charts : Select country and year span to visualize GPI score & rank in line chart", align = "center"),
                                  h4("Map : Select a country and year to visualize GPI score over a  map", align = "center"),
